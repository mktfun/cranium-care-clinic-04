    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-sm text-muted-foreground">
          Distribuição por severidade - Total: {totalPacientes} pacientes
        </CardDescription>
      </CardHeader>
      <CardContent className="pb-4">
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height={altura}>
            <PieChart>
              <Pie
                ...
                outerRadius={Math.min(altura * 0.35, 80)}
                fill="#8884d8"
                dataKey="value"
              >
          ...
          <div className="flex justify-center items-center text-muted-foreground" style={{ height: altura }}>

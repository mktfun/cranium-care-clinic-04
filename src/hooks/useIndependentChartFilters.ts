...
export interface IndependentFilterState {
  timePeriod: string;
...
export function useIndependentChartFilters(defaultPeriod: string = "6months") {
  const [filters, setFilters] = useState<IndependentFilterState>({
